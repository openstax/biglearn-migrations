...
def upgrade():
    ...
    op.execute(CreateSequence(Sequence('content_ecosystems_id_seq')))
    op.create_table('content_ecosystems',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_ecosystems_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('delayed_jobs_id_seq')))
    op.create_table('delayed_jobs',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('delayed_jobs_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('entity_roles_id_seq')))
    op.create_table('entity_roles',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('entity_roles_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('fine_print_contracts_id_seq')))
    op.create_table('fine_print_contracts',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('fine_print_contracts_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('fine_print_signatures_id_seq')))
    op.create_table('fine_print_signatures',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('fine_print_signatures_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('legal_targeted_contract_relationships_id_seq')))
    op.create_table('legal_targeted_contract_relationships',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('legal_targeted_contract_relationships_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('legal_targeted_contracts_id_seq')))
    op.create_table('legal_targeted_contracts',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('legal_targeted_contracts_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('oauth_access_grants_id_seq')))
    op.create_table('oauth_access_grants',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('oauth_access_grants_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('oauth_access_tokens_id_seq')))
    op.create_table('oauth_access_tokens',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('oauth_access_tokens_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('oauth_applications_id_seq')))
    op.create_table('oauth_applications',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('oauth_applications_id_seq'::regclass)"), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('openstax_accounts_accounts_id_seq')))
    op.create_table('openstax_accounts_accounts',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('openstax_accounts_accounts_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('openstax_accounts_group_members_id_seq')))
    op.create_table('openstax_accounts_group_members',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('openstax_accounts_group_members_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('openstax_accounts_group_nestings_id_seq')))
    op.create_table('openstax_accounts_group_nestings',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('openstax_accounts_group_nestings_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('openstax_accounts_group_owners_id_seq')))
    op.create_table('openstax_accounts_group_owners',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('openstax_accounts_group_owners_id_seq'::regclass)"), nullable=False),
    sa.Column('group_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('openstax_accounts_groups_id_seq')))
    op.create_table('openstax_accounts_groups',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('openstax_accounts_groups_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('salesforce_attached_records_id_seq')))
    op.create_table('salesforce_attached_records',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('salesforce_attached_records_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('salesforce_users_id_seq')))
    op.create_table('salesforce_users',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('salesforce_users_id_seq'::regclass)"), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('uid', sa.String(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('school_district_districts_id_seq')))
    op.create_table('school_district_districts',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('school_district_districts_id_seq'::regclass)"), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.execute(CreateSequence(Sequence('settings_id_seq')))
    op.create_table('settings',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('settings_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('short_code_short_codes_id_seq')))
    op.create_table('short_code_short_codes',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('short_code_short_codes_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_assistants_id_seq')))
    op.create_table('tasks_assistants',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_assistants_id_seq'::regclass)"), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_tasked_external_urls_id_seq')))
    op.create_table('tasks_tasked_external_urls',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_tasked_external_urls_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_tasked_interactives_id_seq')))
    op.create_table('tasks_tasked_interactives',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_tasked_interactives_id_seq'::regclass)"), nullable=False),
    sa.Column('url', sa.String(), nullable=False),
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('title', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_tasked_placeholders_id_seq')))
    op.create_table('tasks_tasked_placeholders',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_tasked_placeholders_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_tasked_readings_id_seq')))
    op.create_table('tasks_tasked_readings',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_tasked_readings_id_seq'::regclass)"), nullable=False),
    sa.Column('url', sa.String(), nullable=False),
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('title', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_tasked_videos_id_seq')))
    op.create_table('tasks_tasked_videos',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_tasked_videos_id_seq'::regclass)"), nullable=False),
    sa.Column('url', sa.String(), nullable=False),
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('title', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('time_zones_id_seq')))
    op.create_table('time_zones',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('time_zones_id_seq'::regclass)"), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    ...
    op.execute(CreateSequence(Sequence('user_tours_id_seq')))
    op.create_table('user_tours',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('user_tours_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('catalog_offerings_id_seq')))
    op.create_table('catalog_offerings',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('catalog_offerings_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('content_books_id_seq')))
    op.create_table('content_books',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_books_id_seq'::regclass)"), nullable=False),
    sa.Column('url', sa.String(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('content_maps_id_seq')))
    op.create_table('content_maps',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_maps_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('content_pools_id_seq')))
    op.create_table('content_pools',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_pools_id_seq'::regclass)"), nullable=False),
    sa.Column('content_ecosystem_id', sa.Integer(), nullable=False),
    sa.Column('uuid', sa.String(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('content_tags_id_seq')))
    op.create_table('content_tags',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_tags_id_seq'::regclass)"), nullable=False),
    sa.Column('content_ecosystem_id', sa.Integer(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('school_district_schools_id_seq')))
    op.create_table('school_district_schools',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('school_district_schools_id_seq'::regclass)"), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_task_plans_id_seq')))
    op.create_table('tasks_task_plans',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_task_plans_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('user_profiles_id_seq')))
    op.create_table('user_profiles',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('user_profiles_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('content_chapters_id_seq')))
    op.create_table('content_chapters',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_chapters_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('content_lo_teks_tags_id_seq')))
    op.create_table('content_lo_teks_tags',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_lo_teks_tags_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('course_profile_courses_id_seq')))
    op.create_table('course_profile_courses',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('course_profile_courses_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('role_role_users_id_seq')))
    op.create_table('role_role_users',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('role_role_users_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_tasking_plans_id_seq')))
    op.create_table('tasks_tasking_plans',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_tasking_plans_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_tasks_id_seq')))
    op.create_table('tasks_tasks',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_tasks_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('user_administrators_id_seq')))
    op.create_table('user_administrators',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('user_administrators_id_seq'::regclass)"), nullable=False),
    sa.Column('user_profile_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['user_profile_id'], ['user_profiles.id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    op.execute(CreateSequence(Sequence('user_content_analysts_id_seq')))
    op.create_table('user_content_analysts',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('user_content_analysts_id_seq'::regclass)"), nullable=False),
    sa.Column('user_profile_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['user_profile_id'], ['user_profiles.id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    op.execute(CreateSequence(Sequence('user_customer_services_id_seq')))
    op.create_table('user_customer_services',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('user_customer_services_id_seq'::regclass)"), nullable=False),
    sa.Column('user_profile_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['user_profile_id'], ['user_profiles.id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    op.execute(CreateSequence(Sequence('user_tour_views_id_seq')))
    op.create_table('user_tour_views',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('user_tour_views_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('content_pages_id_seq')))
    op.create_table('content_pages',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_pages_id_seq'::regclass)"), nullable=False),
    sa.Column('url', sa.String(), nullable=False),
    sa.Column('content', sa.Text(), nullable=True),
    ...
    op.execute(CreateSequence(Sequence('course_content_course_ecosystems_id_seq')))
    op.create_table('course_content_course_ecosystems',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('course_content_course_ecosystems_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('course_content_excluded_exercises_id_seq')))
    op.create_table('course_content_excluded_exercises',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('course_content_excluded_exercises_id_seq'::regclass)"), nullable=False),
    sa.Column('course_profile_course_id', sa.Integer(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('course_membership_periods_id_seq')))
    op.create_table('course_membership_periods',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('course_membership_periods_id_seq'::regclass)"), nullable=False),
    sa.Column('course_profile_course_id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('course_membership_students_id_seq')))
    op.create_table('course_membership_students',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('course_membership_students_id_seq'::regclass)"), nullable=False),
    sa.Column('course_profile_course_id', sa.Integer(), nullable=False),
    sa.Column('entity_role_id', sa.Integer(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('course_membership_teachers_id_seq')))
    op.create_table('course_membership_teachers',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('course_membership_teachers_id_seq'::regclass)"), nullable=False),
    sa.Column('course_profile_course_id', sa.Integer(), nullable=False),
    sa.Column('entity_role_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_course_assistants_id_seq')))
    op.create_table('tasks_course_assistants',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_course_assistants_id_seq'::regclass)"), nullable=False),
    sa.Column('course_profile_course_id', sa.Integer(), nullable=False),
    sa.Column('tasks_assistant_id', sa.Integer(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_performance_report_exports_id_seq')))
    op.create_table('tasks_performance_report_exports',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_performance_report_exports_id_seq'::regclass)"), nullable=False),
    sa.Column('course_profile_course_id', sa.Integer(), nullable=False),
    sa.Column('entity_role_id', sa.Integer(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_task_steps_id_seq')))
    op.create_table('tasks_task_steps',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_task_steps_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('content_exercises_id_seq')))
    op.create_table('content_exercises',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_exercises_id_seq'::regclass)"), nullable=False),
    sa.Column('url', sa.String(), nullable=False),
    sa.Column('content', sa.Text(), nullable=True),
    ...
    op.execute(CreateSequence(Sequence('content_page_tags_id_seq')))
    op.create_table('content_page_tags',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_page_tags_id_seq'::regclass)"), nullable=False),
    sa.Column('content_page_id', sa.Integer(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('course_membership_enrollments_id_seq')))
    op.create_table('course_membership_enrollments',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('course_membership_enrollments_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_concept_coach_tasks_id_seq')))
    op.create_table('tasks_concept_coach_tasks',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_concept_coach_tasks_id_seq'::regclass)"), nullable=False),
    sa.Column('content_page_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('entity_role_id', sa.Integer(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_taskings_id_seq')))
    op.create_table('tasks_taskings',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_taskings_id_seq'::regclass)"), nullable=False),
    sa.Column('entity_role_id', sa.Integer(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('content_exercise_tags_id_seq')))
    op.create_table('content_exercise_tags',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('content_exercise_tags_id_seq'::regclass)"), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('course_membership_enrollment_changes_id_seq')))
    op.create_table('course_membership_enrollment_changes',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('course_membership_enrollment_changes_id_seq'::regclass)"), nullable=False),
    sa.Column('user_profile_id', sa.Integer(), nullable=False),
    ...
    op.execute(CreateSequence(Sequence('tasks_tasked_exercises_id_seq')))
    op.create_table('tasks_tasked_exercises',
    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('tasks_tasked_exercises_id_seq'::regclass)"), nullable=False),
    sa.Column('content_exercise_id', sa.Integer(), nullable=False),
    sa.Column('url', sa.String(), nullable=False),
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('title', sa.String(), nullable=True),
